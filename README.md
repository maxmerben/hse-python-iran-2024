...
|03.02.25|Текстовые файлы (продолжение)<br>Обработка текста| |1. 👁 видео из темы №9<br>2. задачи из темы №9<br> 3. [доп. задачи 10.1–10.2](https://github.com/maxmerben/hse-python-iran-2024/blob/main/seminars/hse-python-iran-sem10-tasks.ipynb)|
